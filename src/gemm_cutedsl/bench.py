...
from .spec import GemmProblem, correctness_problem, problem_from_dims, validate_problem
...
def _correctness_problem_from_dims(
    step: int,
    m: int | None,
    n: int | None,
    k: int | None,
    ...
    if m is None and n is None and k is None:
        return correctness_problem(step)
    return problem_from_dims(step, m, n, k)
...
def run_correctness_suite(
    ...
    *,
    ...
    for offset, step in enumerate(steps):
        problem = _correctness_problem_from_dims(step, m, n, k)
        results.append(
            check_correctness(
                arch,
                step,
